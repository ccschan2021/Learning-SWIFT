...
repeat {
    ...
    print("Run: \(run2) \(rand[0]) \(rand[1]) \(rand[2]) \(rand[3]) \(rand[4]) \(rand[5]) \(rand[6])")
}
while (((rand[0] != res[0]) || (rand[1] != res[1]) || (rand[2] != res[2]) || (rand[3] != res[3]) || (rand[4] != res[4]) || (rand[5] != res[5]) || (rand[6] != res[6])) && (run2 < 4))
